...
namespace TD.Dynamic
{
    ...
    /// </summary>
    [DebuggerStepThrough]
    public sealed class JsonDynamic : DynamicObject
    {
        ...
        #region Entrance
        /// <summary>
        /// Prevents a default instance of the <see cref="JsonDynamic"/> class from being created.
        /// </summary>
        /// <param name="obj">The obj.</param>
        private JsonDynamic(ref object obj)
        {
            Value = obj;
        }
        ...
        /// </summary>
        /// <param name="obj">The obj.</param>
        public JsonDynamic(object obj)
        {
            Value = obj;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="JsonDynamic"/> class.
        /// </summary>
        /// <param name="json">The json.</param>
        public JsonDynamic(string json)
        {
        ...
        private bool TryGetField(string name, out object result)
        {
            ...
            if (Value is object[] && (name == "Count" || name == "Length"))
            {
